...
signal request_summon_replace(card: UsableCard, req: CardPlayRequest, preview: SummonPreview)#ctx: CardActionContext, effect: SummonEffect, skip_action: CardAction)
