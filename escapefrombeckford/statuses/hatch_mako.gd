class_name HatchMakoStatus extends Status

const ID := &"hatch_mako"
const MAKO_DATA := preload("res://combatants/critters/Mako/mako_data.tres")
...
func get_tooltip(_stacks: int = 0) -> String:
	return "Hatch Mako: On death, summon a Mako here."
...
func on_removal(ctx: SimStatusContext, removal_ctx) -> void:
	...
	summon_ctx.summon_data = MAKO_DATA.duplicate(true)
	summon_ctx.mortality = CombatantState.Mortality.WILD
	summon_ctx.reason = "hatch_mako"
