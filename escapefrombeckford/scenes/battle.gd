...
#enum InteractionMode { NORMAL, SUMMON_REPLACE, SWAP_PARTNER, DISCARD }
...
func _ready() -> void:
	...
	#Events.request_summon_replace.connect(battle_interaction_handler.on_request_summon_replace)
