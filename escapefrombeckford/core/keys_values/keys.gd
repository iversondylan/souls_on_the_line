...
const OVERLOAD_OVERRIDE := &"overload_override"
const RESERVE_RELEASE_DESTINATION := &"reserve_release_destination"
...
const EFFECT_PACKAGE_INDEX := &"effect_package_index"
const EFFECT_SEQUENCE_KIND := &"effect_sequence_kind"
const COMPACT_TO_PREVIOUS := &"compact_to_previous"
...
const IS_PROJECTED := &"is_projected"
const PROJECTION_VISIBLE := &"projection_visible"
const PROJECTION_SOURCE_OWNER_ID := &"projection_source_owner_id"
const PROJECTION_SOURCE_STATUS_ID := &"projection_source_status_id"
const PROJECTION_TARGET_IDS := &"projection_target_ids"
...
const STATUS_STACKS := &"status_stacks"
