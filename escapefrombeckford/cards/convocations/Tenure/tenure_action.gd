...
func activate_sim(ctx: CardContext) -> bool:
	...
	removal_ctx.reason = "card_tenure"
	removal_ctx.reserve_release_destination = CardMoveContext.BinKind.HAND
	removal_ctx.reserve_release_overload_override = 0
